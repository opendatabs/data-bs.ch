...
export basedir="/home/ubuntu/workspace/public_html/lufthygiene/daten/roh"
#Append contents of each partial csv file (except the two header lines) to the complete csv file, then archive the partial files
